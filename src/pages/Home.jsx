...
<section className="relative max-w-5xl mx-auto text-center py-10">
  ...
  <h1 className="text-5xl md:text-6xl font-light tracking-[0.14em] leading-tight mb-8">
    Minimal Templates
    <br />
  ...
  <Link
    ...
    className="inline-block text-xs tracking-[0.28em] uppercase text-white/50 hover:text-white transition"
  >
